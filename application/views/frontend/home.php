      ...
      <div class="box box-info box-solid" style="border: 1px solid #2ABB9B !important;">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <label for="" class="col-sm-2 control-label">Cari NIS</label>
            <div class="col-sm-3">
              <input type="text" autofocus name="r" <?php echo (isset($f['r'])) ? 'placeholder="' . $f['r'] . '"' : 'placeholder="Cari NIS Siswa"' ?> class="form-control" required>
            </div>
