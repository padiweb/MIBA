			...
			<div class="box-body">
				...
				<div class="col-md-5">
					<div class="box box-success">
						...
						<div class="box-body">
							...
							<?php if (majors() == 'senior') { ?>
								<div class="form-group">
									<label for="" class="col-sm-4 control-label">Unit Pendidikan</label>
									<div class="col-sm-8">
					...
					<div class="box box-success">
						...
						<div class="box-body">
							<div class="form-group">
								<label for="" class="col-sm-4 control-label">Nominal Bulanan (Rp.)</label>
								<div class="col-sm-8">
				...
				<div class="col-md-7">
					<div class="box box-success">
						<div class="box-header">
							<h3 class="box-title">Nominal Setiap Bulan Tidak Sama</h3>
						</div>
						<div class="box-body">
							<table class="table">
								<tbody>
						...
						<div class="box-footer">
							<button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Update Nominal</button>
							<a href="<?php echo site_url('manage/payment/view_bulan/' . $payment['payment_id']) ?>" class="btn btn-default"><i class="fa fa-repeat"></i> Cancel</a>
						</div>
					</div>
				</div>
				<?php echo form_close(); ?>
