			...
			<div class="col-md-12">
				<div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title">Nominal - <?php echo $payment['pos_name'] . ' - T.A ' . $payment['period_start'] . '/' . $payment['period_end'] ?></h3>
					</div><!-- /.box-header -->
					<div class="box-body">
						...
						<div class="form-group">
							...
							<?php if (majors() == 'senior') { ?>
								<label for="" class="col-sm-2 control-label">Unit Pendidikan</label>
								<div class="col-sm-2">
						...
						<div class="col-sm-10">
							...
							<?php if (majors() == 'senior') { ?>
								<a class="btn btn-warning btn-sm" href="<?php echo site_url('manage/payment/add_payment_bulan_majors/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Berdasarkan Unit Pendidikan</a>
							<?php } ?>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<?php endif ?>
											<td>
												<a href="<?php echo site_url('manage/payment/edit_payment_bulan/' . $row['payment_payment_id'] . '/' . $row['student_student_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Ubah Nominal"><i class="fa fa-edit"></i></a>
