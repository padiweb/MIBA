						...
						<div class="nav-tabs-custom">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
									...
									<div class="form-group">
										<label>NIK</label>
										<input name="student_hobby" type="text" class="form-control" value="<?php echo $inputHobbyValue ?>" placeholder="NIK">
									</div>
			...
			<div class="col-md-3">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('student/profile'); ?>" class="btn btn-block btn-info"><i class="fa fa-close"></i> Batal</a>
					</div>
					<!-- /.box-body -->
				</div>
			</div>
