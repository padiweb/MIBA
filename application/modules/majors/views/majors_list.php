			...
			<div class="col-xs-12">
				<div class="box box-success">
					<div class="box-header with-border">
						<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addMajors"><i class="fa fa-plus"></i> Tambah Data</button>
						<div class="box-tools">
							<?php echo form_open(current_url(), array('class' => 'form-horizontal', 'method' => 'get')) ?>
							<div class="input-group input-group-sm" style="width: 250px;">
								<input type="text" id="field" autofocus name="n" <?php echo (isset($f['n'])) ? 'placeholder="' . $f['n'] . '"' : 'placeholder="Unit Sekolah"' ?> class="form-control" required>
				...
				<div id="p_scents_majors">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<input type="text" required="" name="majors_short_name[]" class="form-control" placeholder="Contoh: IPA">
						</div>
					</div>
				</div>
