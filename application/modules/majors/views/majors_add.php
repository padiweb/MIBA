				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input name="majors_name" type="text" class="form-control" value="<?php echo $inputMajorsValue ?>" placeholder="Isi Unit Sekolah">
						</div>

						<div class="form-group">
							<label>Singkatan Unit <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
							<input name="majors_short_name" type="text" class="form-control" value="<?php echo $inputShortValue ?>" placeholder="Isi Singkatan Unit">
						</div>
