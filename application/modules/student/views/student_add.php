							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
									...
									<div class="form-group">
										...
										<input name="student_hobby" type="text" class="form-control" value="<?php echo $inputHobbyValue ?>" placeholder="No. Induk Keluarga">
									</div>
			...
			<div class="col-md-3">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<?php if (isset($student)) { ?>
							<button type="button" onclick="getId(<?php echo $student['student_id'] ?>)" class="btn btn-danger btn-block" data-toggle="modal" data-target="#deleteStudent"><i class="fa fa-close"></i> Hapus
							</button>
						<?php } ?>
					</div>
					<!-- /.box-body -->
