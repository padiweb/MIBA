...
class Bulan_model extends CI_Model
{
    ...
    function get_total($params = array())
    {
        ...
        $this->db->order_by('month_month_id', 'asc');
        $this->db->select('bulan.bulan_id, bulan_bill, bulan_date_pay, bulan_status, bulan_pay_desc, bulan_input_date, bulan_last_update');
    ...
    function add($data = array())
    {
        ...
        if (isset($data['bulan_pay_desc'])) {
            $this->db->set('bulan_pay_desc', $data['bulan_pay_desc']);
        }
